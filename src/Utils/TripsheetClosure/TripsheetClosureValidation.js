export default function TripsheetClosureValidation(values, isTouched) {
  ...
  } else if (isTouched.toll_amount && !values.toll_amount.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.bata && !values.bata.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.municipal_charges && !values.municipal_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.port_entry_fee && !values.port_entry_fee.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.misc_charges && !values.misc_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.fine_amount && !values.fine_amount.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.sub_delivery_charges && !values.sub_delivery_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.maintenance_cost && !values.maintenance_cost.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.loading_charges && !values.loading_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.unloading_charges && !values.unloading_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.tarpaulin_charges && !values.tarpaulin_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.weighment_charges && !values.weighment_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.low_tonage_charges && !values.low_tonage_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.low_tonnage_charges && !values.low_tonnage_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.halting_charges && !values.halting_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.freight_charges && !values.freight_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.halt_days && !values.halt_days.match(/^[0-9]{0,6}$/)) {
  ...
  if (isTouched.diversion_return_charges && !values.diversion_return_charges) {
    ...
    !values.diversion_return_charges.match(/^[0-9]{0,6}$/)
  ) {
  ...
  } else if (isTouched.rjso_weighment_charges && !values.rjso_weighment_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.rjso_misc_charges && !values.rjso_misc_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.rjso_commision_charges && !values.rjso_commision_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.rjso_bata_amount && !values.rjso_bata_amount.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.rjso_loading_charges && !values.rjso_loading_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.rjso_unloading_charges && !values.rjso_unloading_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.rjso_tarpaulin_charges && !values.rjso_tarpaulin_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.rjso_munic_charges && !values.rjso_munic_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.rjso_halt_charges && !values.rjso_halt_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.rjso_en_diesel_charges && !values.rjso_en_diesel_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.fci_atti_cooli_charges && !values.fci_atti_cooli_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.fci_extra_charges && !values.fci_extra_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.fci_office_exp_charges && !values.fci_office_exp_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.fci_gate_exp_charges && !values.fci_gate_exp_charges.match(/^[0-9]{0,6}$/)) {
  ...
  } else if (isTouched.fci_weighment_charges && !values.fci_weighment_charges.match(/^[0-9]{0,6}$/)) {
