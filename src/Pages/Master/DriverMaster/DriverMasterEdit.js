...
const DriverMaster = () => {
  ...
  function addNewDriver() {
    ...
    let current_info = getOldLogInfo(singleDriver.log_info)
    current_info.push({
      driver_type_id: values.driverType,
      driver_name: values.driverName,
      driver_code: values.driverCode,
      driver_phone_1: values.driverMobile1,
      driver_phone_2: values.driverMobile2,
      license_no: values.licenseNumber,
      license_validity_to: values.licenseValidDate,
      license_validity_status: values.licenseValidityStatus,
      driver_address: values.driverAddress,
      driver_assigned_status: singleDriver ? singleDriver.driver_assigned_status : 0,
      type: 2,
