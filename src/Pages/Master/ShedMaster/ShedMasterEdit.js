...
const ShedMasterEdit = () => {
  ...
  function addNewShed() {
    ...
    let current_info = getOldLogInfo(singleShed.log_info)
    current_info.push({
      shed_type_id: values.ShedType,
      shed_name: values.ShedName,
      shed_owner_name: values.ShedOwnerName,
      shed_owner_phone_1: values.ShedOwnerMobileNumber1,
      shed_owner_phone_2: values.ShedOwnerMobileNumber2,
      shed_owner_address: values.ShedOwnerAddress,
      pan_number: values.PANNumber,
      shed_adhar_number: values.AadharNumber,
