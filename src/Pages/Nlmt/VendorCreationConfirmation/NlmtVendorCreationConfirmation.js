...
const NlmtVendorCreationConfirmation = () => {
  ...
  let page_no = NlmtScreenAccessCodes.NlmtVendorCreationScreens.Nlmt_Vendor_Confirmation
  ...
  const formValues = {
    ...
    vc_request_remarks: '',
    vc_approval_remarks: '',
    vc_tax_approval_remarks: '',
    vc_confirmation_remarks: '',
    tax_remarks: '',
    // Files
    panCopy: '',
    aadharCopy: '',
  ...
  useEffect(() => {
    NlmtDocumentVerificationService.getSingleVehicleInfoOnTripIn(id).then((res) => {
      ...
      values.GSTtaxType = resData.vendor_info.gst_tax_type
      ...
      values.remarks = resData.vendor_info.remarks || ''
       values.tax_remarks = resData.vendor_info.tax_remarks
  ...
  useEffect(() => {
    ...
    let GSTtaxTypeVal = !errors.GSTtaxType && values.GSTtaxType
  ...
  function createVendor() {
    ...
    NlmtVendorCreationService.nlmtVendorCreation(SAPdata)
      .then((res) => {
        console.log(res)
        ...
        //  formData.append('tax_remarks', values.tax_remarks)
        formData.append('vendor_code', res.data.VENDOR_NO)

        formData.append('vc_confirmation_remarks', values.vc_confirmation_remarks || '')
        formData.append('vc_confirmation_by', user_id)
          ...
          .then((res) => {
            ...
            if (res.status === 200) {
              ...
              Swal.fire({
                ...
                html: `
    <p>Vendor has been uploaded to SAP.</p>
  `,
                confirmButtonColor: '#28a745'
              }).then(() => {
                navigation('/NlmtVendorConfirmationTable')
              })
            } else {
  ...
  const formalTimeConverter = (time_string) => {
    ...
    const date = new Date(time_string.replace(" ", "T"));
  ...
  const addVendorRequest = (status) => {
    ...
    formData.append('gst_tax_type', values.GSTtaxType || 1245)
            ...
            <>
              <CCard>
                <CForm className="container p-3" onSubmit={handleSubmit}>
                  ...
                  <CRow className="">
                      ...
                      <>
                        <CCol xs={12} md={3}>
                          ...
                          <CFormInput
                            size="sm"
                            id="Vnum"
                            value={currentInfo.tripsheet_info ? currentInfo.tripsheet_info.nlmt_tripsheet_no : ''}
                            readOnly
                          />
                        </CCol>
                      </>
                    )}
                    {currentInfo.vehicle_info && (
                      <>
                        <CCol xs={12} md={3}>
                          ...
                          <CFormInput
                            size="sm"
                            id="Vnum"
                            value={currentInfo.vehicle_info ? currentInfo.vehicle_info.vehicle_number : ''}
                            readOnly
                          />
                        </CCol>
                      </>
                    ...
                    {values.GSTreg == 1 && (
                      <>
                        ...
                        <CCol xs={12} md={3}>
                          <CFormLabel htmlFor="GSTtax">GST Tax Type</CFormLabel>

                          <CFormSelect
                            size="sm"
                            id="GSTtaxType"
                            name="GSTtaxType"
                            value={values.GSTtaxType}
                            disabled
                            aria-label="Small select example"
                          >
                            <option value="0">Select...</option>
                            {gstType.map(({ definition_list_code, definition_list_name }) => {
                              return (
                                <>
                    ...
                    <CCol xs={12} md={3}>
                      <CFormLabel htmlFor="vc_confirmation_remarks">
                        Remarks  
                      </CFormLabel>
                      <CFormInput
                        size="sm"
                        id="vc_confirmation_remarks"
                        name="vc_confirmation_remarks"
                        value={values.vc_confirmation_remarks ? values.vc_confirmation_remarks : ''}
                        onFocus={onFocus}
                        onBlur={onBlur}
                        onChange={handleChange}
                      />
                  ...
                  <CRow>
                    <CCol xs={12} md={3}>
                      <CFormLabel htmlFor="Vnum">VC Request Remarks</CFormLabel>
                      <CFormInput
                        size="sm"
                        id="Vnum"
                        value={currentInfo.vendor_info ? currentInfo.vendor_info.vc_request_remarks : ''}
                        readOnly
                      />
                    </CCol>
                    <CCol xs={12} md={3}>
                      <CFormLabel htmlFor="Vnum">VC Request Time</CFormLabel>
                      <CFormInput
                        size="sm"
                        id="Vnum"
                        value={currentInfo.vendor_info ? formalTimeConverter(currentInfo.vendor_info.vc_request_at) : ''}
                        readOnly
                      />
                    </CCol>
                    <CCol xs={12} md={3}>
                      <CFormLabel htmlFor="Vnum">VC Approval Remarks</CFormLabel>
                      <CFormInput
                        size="sm"
                        id="Vnum"
                        value={currentInfo.vendor_info ? currentInfo.vendor_info.vc_approval_remarks : ''}
                        readOnly
                      />
                    </CCol>
                    <CCol xs={12} md={3}>
                      <CFormLabel htmlFor="Vnum">VC Approval Time</CFormLabel>
                      <CFormInput
                        size="sm"
                        id="Vnum"
                        value={currentInfo.vendor_info ? formalTimeConverter(currentInfo.vendor_info.vc_approval_at) : ''}
                        readOnly
                      />
                    </CCol>
                    <CCol xs={12} md={3}>
                      <CFormLabel htmlFor="Vnum">VC TAX Approval Remarks</CFormLabel>
                      <CFormInput
                        size="sm"
                        id="Vnum"
                        value={currentInfo.vendor_info ? currentInfo.vendor_info.vc_tax_approval_remarks : ''}
                        readOnly
                      />
                    </CCol>
                    <CCol xs={12} md={3}>
                      <CFormLabel htmlFor="Vnum">VC TAX Approval Time</CFormLabel>
                      <CFormInput
                        size="sm"
                        id="Vnum"
                        value={currentInfo.vendor_info ? formalTimeConverter(currentInfo.vendor_info.vc_tax_approval_at) : ''}
                        readOnly
                      />
                    </CCol>
                  </CRow>
                  ...
                  <CRow>
                    <CCol>
                      <Link to="/NlmtVendorConfirmationTable">
                        <CButton
                          md={9}
                          size="sm"
                          color="primary"
