...
const NlmtVendorCreationTaxApproval = () => {
  ...
  let page_no = NlmtScreenAccessCodes.NlmtVendorCreationScreens.Nlmt_Vendor_Tax_Approval
  ...
  const addVendorRequest = (status) => {
    ...
    formData.append('gst_tax_type', values.GSTtaxType)
    ...
    formData.append('vc_tax_approval_remarks', values.vc_tax_approval_remarks || '')
    formData.append('vc_tax_approval_by', user_id)
      ...
      .then((res) => {
        ...
        if (res.status == 200) {
          if (status == 3
            ...
            navigation('/NlmtVendorTaxApprovalTable')
          } else {
              ...
              <CCard>
                <CForm className="container p-3" onSubmit={handleSubmit}>
                  ...
                  <CRow className="">
                      ...
                      <>
                        ...
                        <CCol xs={12} md={3}>
                          <CFormLabel htmlFor="GSTtaxType">
                            GST Tax Type
                            <X />{' '}
                            {errors.GSTtaxType && <span className="small text-danger">{errors.GSTtaxType}</span>}
                          </CFormLabel>
                          ...
                          <CFormSelect
                            ...
                            onBlur={onBlur}
                            onChange={handleChange}
                            className={`${errors.GSTtaxType && 'is-invalid'}`}
                            aria-label="Small select example"
                          >
                    ...
                    <CCol xs={12} md={3}>
                      <CFormLabel htmlFor="vc_tax_approval_remarks">
                        TAX Team - Text 
                      </CFormLabel>
                      <CFormInput
                        size="sm"
                        id="vc_tax_approval_remarks"
                        name="vc_tax_approval_remarks"
                        value={values.vc_tax_approval_remarks ? values.vc_tax_approval_remarks : ''}
                        onFocus={onFocus}
                        onBlur={onBlur}
                        onChange={handleChange}
                      />
                  ...
                  <CRow>
                    <CCol>
                      <Link to="/NlmtVendorTaxApprovalTable">
                        <CButton
                          md={9}
                          size="sm"
                          color="primary"
...
export default NlmtVendorCreationTaxApproval
