...
const NlmtVendorTaxApprovalTable = () => {
  /*================== User Location Fetch ======================*/
  ...
  const loadVendorApprovalTable = () => {
    NlmtVendorCreationService.getVendorTaxApprovalTableData().then((res) => {
        ...
        rowDataList.push({
          ...
          Action: (
            <CButton className="badge" color="warning">
              <Link className="text-white" to={`NlmtVendorCreationTaxApproval/${data.nlmt_trip_in_id}`}>
                Approve Vendor
              </Link>
            </CButton>
          ),
...
export default NlmtVendorTaxApprovalTable
