...
const NlmtSettlementClosureInfo = () => {
  ...
  let page_no1 = NlmtScreenAccessCodes.NlmtClosureScreens.Nlmt_Payment_Submission
  let page_no2 = NlmtScreenAccessCodes.NlmtClosureScreens.Nlmt_Payment_Validation
  let page_no3 = NlmtScreenAccessCodes.NlmtClosureScreens.Nlmt_Payment_Approval

  useEffect(()=>{

    if( user_info.is_admin == 1 || 
        JavascriptInArrayComponent(page_no1,user_info.page_permissions) || 
        JavascriptInArrayComponent(page_no2,user_info.page_permissions) || 
        JavascriptInArrayComponent(page_no3,user_info.page_permissions)       
      ){
                  ...
                  <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={mainKey === 1}>
                    ...
                    <CTabContent>
                      ...
                      <CTabPane role="tabpanel" aria-labelledby="profile-tab" visible={activeKey === 7}>
                        ...
                        {tripsettlementData.advance_amount == 10 && tripInfo.advance_payment_info && (
                          <CRow className="mt-2">
                            <CCol xs={12} md={2}>
                        ...
                        >
                              ...
                              {values.diversion_return_charges > 0 && (
                                <>
                                  <CTableRow style={{ backgroundColor: '#f8d7da' }}>
                                    ...
                                    <CTableDataCell style={{ width: '180px' }}>
                                      <CFormLabel>Ref.No</CFormLabel>
                                      <CFormInput
                                        name="ded_remarks"
                                        // value={values.ded_remarks}
                                        value={tripsettlementData.ded_ref}
                                        onChange={handleChange}
                                        readOnly
                                      />
                                    </CTableDataCell>
                              ...
                              {tripInfo && tripInfo.advance_payment_info && tripInfo.advance_payment_info.tds_type ? (
                                  ...
                                  <CTableRow>
                                    ...
                                    <CTableDataCell>
                                      <CFormInput
                                        ...
                                        value={tripInfo.advance_payment_info.tds_type == 1 ? 'Yes' : 'No'}
                                        readOnly
                                      />
                                    </CTableDataCell>
                                  </CTableRow>
                                ...
                                <>
                                  <CTableRow>
                                    ...
                                    <CTableDataCell>Tds Tax Type 11</CTableDataCell>
                                    <CTableDataCell>
                                      <CFormInput
                                        size="sm"
                                        id="TdsHaving"
                          ...
                          <CRow className="mt-2">
                            <CCol xs={12} md={3}>
                              ...
                              <CFormInput size="sm" value={tripsettlementData.remarks} readOnly />
                            </CCol>

                            {tripsettlementData.advance_amount == 100 && (
                              <>
                                <CCol xs={12} md={2}>
                                  <CFormLabel htmlFor="remarks">Expense SAP Amount</CFormLabel>
                                  <CFormInput size="sm" value={tripsettlementData.sap_expense_amount} readOnly />
                                </CCol>
                                <CCol xs={12} md={2}>
                                  <CFormLabel htmlFor="remarks">Expense SAP Doc.</CFormLabel>
                                  <CFormInput size="sm" value={tripsettlementData.expense_sap_document_no} readOnly />
                                </CCol>
                                <CCol xs={12} md={2}>
                                  <CFormLabel htmlFor="remarks">Posting date</CFormLabel>
                                  <CFormInput size="sm" value={tripsettlementData.expense_posting_date} readOnly />
                                </CCol>
                              </>
                            )}
                            <CCol xs={12} md={3}>
                              <CFormLabel htmlFor="remarks">Approval Remarks</CFormLabel>
                              <CFormInput size="sm" value={tripsettlementData.approval_remarks} readOnly />
                            </CCol>
                          </CRow>
                          <CRow>
                            <CCol
                ...
                >
                  ...
                  <CModalBody>
                    {tripInfo.trip_vehicle_info &&
                      tripInfo.trip_vehicle_info.vehicle_type_id &&
                      tripInfo.trip_vehicle_info.vehicle_type_id !== 22 && (
                        <>
...
export default NlmtSettlementClosureInfo
