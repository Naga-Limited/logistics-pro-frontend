...
const NlmtVendorCreationApproval = () => {
  ...
  let page_no = NlmtScreenAccessCodes.NlmtVendorCreationScreens.Nlmt_Vendor_Approval
  ...
  useEffect(() => {
    ...
    console.log('gstRegValidationVal',gstRegValidationVal) 
    console.log('bankAccVal',bankAccVal)
    console.log('bankAccHolderNameVal',bankAccHolderNameVal)
    console.log('bankNameVal',bankNameVal)
    console.log('bankBranchVal',bankBranchVal)
    console.log('ifscCodeVal',ifscCodeVal)
    console.log('GSTtaxVal',GSTtaxVal)
    console.log('GSTtaxTypeVal',GSTtaxTypeVal)
    ...
    console.log('postalcodeVal',postalcodeVal)
    console.log('vendorNameVal',vendorNameVal)
  ...
  const addVendorRequest = (status) => {
    ...
    formData.append('vc_approval_remarks', values.vc_approval_remarks || '')
    formData.append('vc_approval_by', user_id)
              ...
              <CCard>
                <CForm className="container p-3" onSubmit={handleSubmit}>
                  ...
                  <CRow className="">
                    ...
                    <CCol xs={12} md={3}>
                      <CFormLabel htmlFor="vc_approval_remarks">
                        Remarks  
                      </CFormLabel>
                      <CFormInput
                        size="sm"
                        id="vc_approval_remarks"
                        name="vc_approval_remarks"
                        value={values.vc_approval_remarks ? values.vc_approval_remarks : ''}
                        onFocus={onFocus}
                        onBlur={onBlur}
                        onChange={handleChange}
                      />
                  ...
                  <CRow>
                    <CCol>
                      <Link to="/NlmtVendorApprovalTable">
                        <CButton
                          md={9}
                          size="sm"
                          color="primary"
