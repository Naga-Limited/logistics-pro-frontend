...
import { imageUrlValidation } from 'src/Pages/Nlmt/CommonMethods/CommonMethods'

const NlmtSettlementValidationChild = () => {
        ...
        <>
          <CCard className="p-1">
                ...
                <CTabContent>
                        ...
                        {expenseClosureData.vehicle_inspection_info && (
                          <CCol xs={12} md={3}>
                            ...
                            <CFormInput
                              ...
                              value={
                                expenseClosureData.vehicle_inspection_info.inspection_time_string
                              }
                              readOnly
                            />
                          </CCol>
                          ...
                          <>
                            ...
                            <CCol xs={12} md={3}>
                              ...
                              <CFormInput
                                ...
                                id="SRDateTime"
                                value={
                                  expenseClosureData.shipment_parent_info.shipment_date_time_string
                                }
                                readOnly
                              />
                            </CCol>
                  ...
                  <CTabPane role="tabpanel" aria-labelledby="profile-tab" visible={activeKey === 2}>
                    <>
                      ...
                      <CRow key={`HireshipmentData1`} className="mt-2" hidden>
                        ...
                        <CCol md={2}>
                          ...
                          <CFormInput
                            ...
                            value={
                              shipmentInfo.final_shipment_net_qty
                                ? shipmentInfo.final_shipment_net_qty
                                : shipmentInfo.final_shipment_qty
                            }
                            readOnly
                          />
                        </CCol>
                        <CCol md={2}>
                          ...
                          <CFormInput
                            ...
                            id="sft"
                            value={
                              shipmentInfo.freight_type == '2' ? 'Actual Freight' : 'Budget Freight'
                            }
                            readOnly
                          />
                        </CCol>
                      ...
                      {shipmentInfo.shipment_child_info &&
                        shipmentInfo.shipment_child_info.map((val, val_index) => {
                          return (
                            <>
                              <CRow key={`HireshipmentChildData_${val_index}`}>
                                ...
                                <CCol xs={12} md={2}>
                                  ...
                                  <CFormInput
                                    ...
                                    value={
                                      val.invoice_net_qty
                                        ? `${val.invoice_net_qty} - ${val.invoice_uom}`
                                        : `${val.invoice_qty} - ${val.invoice_uom}`
                                    }
                                    readOnly
                                  />
                                </CCol>
                                ...
                                <CCol xs={12} md={2}>
                                  ...
                                  {imageUrlValidation(
                                    shipmentInfo.shipment_child_info[val_index].fj_pod_copy
                                  ) ? (
                                    <CButton
                                      className="w-100 m-0"
                                      color="info"
                                      ...
                                      <span className="float-end">
                                        <i
                                          ...
                                          onClick={() => {
                                            setCamEnable(true)
                                            setImgSrc(
                                              shipmentInfo.shipment_child_info[val_index]
                                                .fj_pod_copy
                                            )
                                    ...
                                    <>
                                      <CButton
                                        ...
                                        id="inputAddress"
                                      >
                                        <span className="float-start">Image Not Found</span>
                                      </CButton>
                                    </>
                                  )}
                                </CCol>
            ...
            >
              ...
              <CModalBody>
                {imgSrc && !imgSrc.includes('.pdf') ? (
                  <CCardImage orientation="top" src={imgSrc} />
                ) : (
                  <iframe orientation="top" height={500} width={475} src={imgSrc}></iframe>
                )}
              </CModalBody>
...
export default NlmtSettlementValidationChild
