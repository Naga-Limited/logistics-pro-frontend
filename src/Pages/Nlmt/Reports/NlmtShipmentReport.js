...
const NlmtShipmentReport = () => { 
  ...
  let page_no = NlmtScreenAccessCodes.NlmtReportScreens.NLMT_Shipment_Report
  ...
  const exportToCSV = () => {
    ...
    let fileName='NLMT_Shipment_Report_'+dateTimeString
  ...
  const loadTripShipmentReport = (fresh_type = '') => {
    ...
    if (fresh_type !== '1') {
      ...
      NlmtVehicleAssignmentService.getNlmtShipmentDataForReport().then((res) => {
        ...
        filterData.map((data, index) => {
          rowDataList.push({
            ...
            Vehicle_Type: vehicleType(data.trip_sheet_info.trip_vehicle_info.vehicle_type_id,data),
      ...
      NlmtVehicleAssignmentService.sentNlmtShipmentDataForReport(report_form_data).then((res) => {
        console.log(res, 'res')
        tableReportData = res.data.data
        console.log(tableReportData)
                  ...
                  <CRow className="mt-1 mb-1">
                    ...
                    <CCol xs={12} md={3}>
                      ...
                      <NLMTReportSearchSelectComponent
                        ...
                        search_type="nlmt_shipment_report_shipment_number"
                        search_data={searchFilterData}
                      />
                    </CCol>
                    ...
                    <CCol xs={12} md={3}>
                      ...
                      <NLMTReportSearchSelectComponent
                        ...
                        search_type="nlmt_shipment_report_shipment_status"
                        search_data={searchFilterData}
                      />
                    </CCol>
                  </CRow>
...
export default NlmtShipmentReport
