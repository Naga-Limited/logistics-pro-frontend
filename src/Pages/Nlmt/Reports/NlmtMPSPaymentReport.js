...
import { GetDateTimeFormat, imageUrlValidation } from '../CommonMethods/CommonMethods'
...
const NlmtMPSPaymentReport = () => {
  ...
  const exportToCSV = () => {
    ...
    let fileName='Nlmt_Payment_Report_'+dateTimeString
  ...
  const loadTripPaymentReport = (fresh_type = '') => {
    ...
    if (fresh_type !== '1') {
      ...
      NlmtTripSheetClosureService.getNlmtPaymentDataForReport().then((res) => {
        ...
        tableReportData.map((data, index) => {
          rowDataList.push({
            ...
            Vendor_No: data.vendor_info.owner_number, 
            ...
            // Invoice_Copy: imageUrlValidation(data.invoice_copy) == '' ? '--' : (
            //   <a style={{color:'black'}} target='_blank' rel="noreferrer" href={data.invoice_copy}>
            ...
            Action: (
              <CButton className="badge" color="warning">
                <Link className="text-white" to={`${data.id}`}>
                  View
                </Link>
              </CButton>
            ),
      ...
      NlmtTripSheetClosureService.sentNlmtPaymentDataForReport(report_form_data).then((res) => {
                ...
                <CRow className="mt-1 mb-1">
                  ...
                  <CCol xs={12} md={3}>
                    ...
                    <NlmtIASearchSelectComponent
                      ...
                      label="Select Vendor Number"
                      noOptionsMessage="Contractor Not found"
                      search_type="nlmt_payment_report_vendor_name"
                  ...
                  <CCol xs={12} md={3}>
                    ...
                    <NlmtIASearchSelectComponent
                      ...
                      search_type="nlmt_payment_report_payment_status"
                      search_data={searchFilterData}
                    />
                  </CCol>
                </CRow>
...
export default NlmtMPSPaymentReport
