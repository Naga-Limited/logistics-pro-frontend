  ...
  const TripsheetClosureSubmit = (process) => {
    ...
    if (process == 'submit') {
      ...
      if(tripInfo.vehicle_info.vehicle_type_id === 22 && stoTableDataFCI &&
        ...
        /* If Deduction exists, need to proceed approval process */ 
        if(deduction_exists == 1 || (deduction_exists == 0 && advance_percentage == 10)){
          ...
          formData.append('tripsheet_is_settled', deduction_exists == 0 ? 3 : 1)
        ...
        } else { /* If No Deduction, directly post to SAP without approval process */ 
