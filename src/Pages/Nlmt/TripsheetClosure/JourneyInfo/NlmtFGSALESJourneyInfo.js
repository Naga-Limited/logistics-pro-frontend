...
const NlmtFGSALESJourneyInfo = (props) => {
  console.log(props.fgsalesJourneyInfo, 'props.fgsalesJourneyInfo')
      ...
      data1.shipment_child_info.map((data2, index2) => {
        ...
        if (data1.vehicle_type_id == '22') {
          ...
          rowDataList.push({
            ...
            tripsheet_no: data1.trip_sheet_info.nlmt_tripsheet_no,
 ...
 useEffect(() => {
  ...
  if(
    fgsalesTripData &&
    fgsalesTripData.length > 0 &&
    tripShipmentCustomerData.length > 0 &&
    incoTermData.length > 0
  ) {
    getClosureSTOData()
  }

}, [fgsalesTripData, tripShipmentCustomerData, incoTermData])
