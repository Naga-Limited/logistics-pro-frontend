...
const NlmtOwnVehicleStatus = () => {
  ...
  let page_no = NlmtScreenAccessCodes.NlmtTSStatusScreens.Nlmt_Own_Vehicle_Status
  ...
  const exportToCSV = () => {
    ...
    let fileName='NLMT_Own_Vehicle_Status_'+dateTimeString
  ...
  const getOwnVehicleStatusData = () => {
    NlmtVehicleMasterService.getOwnTripVehicles().then((res) => {
            ...
            <CTooltip
              ...
              >
                <CButton className="badge m-3" color="warning">
                  <Link className="text-white" target='_blank' to={`/NlmtVehicleTripSearch`}>
                    NLMT Tripsheet Status
                  </Link>
                </CButton> 
            </CTooltip>
          ),
                ...
                <CContainer className="mt-2">
                    <CRow className="mt-3">
                        ...
                        <CCol md={6} style={{textAlign:'end'}}>  
                            ...
                            >
                                <CTooltip
                                    content={`Click here to find a NLMT Tripsheet Status in an New Tab`}
                                    placement="top"
                                >
                                    <span className="float-start">
                                        <Link target='_blank' to={`/NlmtVehicleTripSearch`}>
                                            <i className="fa fa-eye" style={{ color:"blue" }} aria-hidden="true"></i> &nbsp;
                                            <span style={{ color:"black" }}>NLMT Tripsheet Status </span>
                                        </Link>
                                    </span>
                                </CTooltip>
                            </CButton>                                          
...
export default NlmtOwnVehicleStatus
