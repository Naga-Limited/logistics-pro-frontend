...
import AdditionalDieselIndentDieselVendorSelectComponent from 'src/components/commoncomponent/AdditionalDieselIndentDieselVendorSelectComponent'
        ...
        <CCol xs={12} md={3}>
          <CFormLabel htmlFor="diesel_vendor_name">
            ...
            <CFormSelect
              ...
              aria-label="Small select example"
            >
              <AdditionalDieselIndentDieselVendorSelectComponent/>
            </CFormSelect>
        </CCol>
          <CCol xs={12} md={3}>
