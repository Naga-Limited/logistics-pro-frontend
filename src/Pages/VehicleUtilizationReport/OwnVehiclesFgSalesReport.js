      ...
      VehicleUtilizationService.getOwnFgsalesVehilceUtilizationDataForReport().then((res) => {
        ...
        filterData.map((data, index) => {
          rowDataList.push({
            ...
            Utility:data.volume_utilization ? Math.round(data.volume_utilization)+' %' : '-',
            Utility_View: (
              <CButton
              ...
              >
                ...
                <Link to={`/${'VehicleUtilizationOwnFgReport'}/${data.shipment_id}||${data.parking_id}`} target='_blank'>
