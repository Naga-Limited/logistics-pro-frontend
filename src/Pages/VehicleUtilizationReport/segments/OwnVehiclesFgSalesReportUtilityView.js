                ...
                <tr  style={{height:'650px',background:'white',}}>
                  ...
                  {reportData && (
                    <tr>
                      ...
                      <div style={hd}></div>
                      <strong style={{marginLeft:'2%', color:colorFinder() , fontFamily:"timesnewroman"}}>Vehicle Utilization : {vehicleUtilizationFinder()}</strong><br />
                      <div style={hd}></div>
                      ...
                      <div className="print-container" style={secdiv}> 
                                ...
                                <div>
                                  <table style={{border:'1px solid black', marginTop:'2%', height:'fit-content'}}>
                                    ...
                                    <tr style={{borderTop:'0.5px solid black'}}>
                                      <td colSpan={2} style={{width:'70%',textAlign:'end'}}>Sub Total</td> 
                                      <td style={{width:'10%',textAlign:'center'}}>{findSubTotal(vl.line_item_details)}</td>
                                    </tr>
                        ...
                        <div style={{padding:'1%',borderTop:'1px solid black'}}>
                          <table style={{border:'1px solid black', height:'fit-content'}}>
                            <tr>
                              <td colSpan={2} style={{width:'70%',textAlign:'end'}}>Total Product Volume</td>
                              <td style={{width:'13%',textAlign:'center'}}>{overAllVolumeFinder(reportData.shipment_all_child_info)}</td>
                            </tr>
                          </table>
                        ...
                        <div style={hd}></div>
                        <strong style={{marginLeft:'2%', color:"green", fontFamily:"timesnewroman", fontSize:"medium"}}>Vehicle Utilization :</strong><br />
