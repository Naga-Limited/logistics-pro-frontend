...
const DepoSettlementApprovalChild = () => {
  ...
  let page_no_report = LogisticsProScreenNumberConstants.DepoModuleScreens.Depo_Final_Report

  useEffect(()=>{

    if(user_info.is_admin == 1 || JavascriptInArrayComponent(page_no,user_info.page_permissions) || JavascriptInArrayComponent(page_no_report,user_info.page_permissions)){
