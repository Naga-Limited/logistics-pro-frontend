      ...
      DepoShipmentCreationService.getSingleDepoShipmentChildInfo().then((res) => {
        ...
        filterData.map((data, index) => {
          ...
          rowDataList.push({
            ...
            BUDGET_VS_ACTUAL:
              data.shipment_depo_actual_freight_amount - data.shipment_depo_budget_freight_amount,
            ...
            Shipment_SAP_Freight: data.shipment_child_info[index1].delivery_sap_freight_amount,
            Shipment_SAP_Prim_Freight: data.shipment_child_info[index1].delivery_sap_primary_freight_amount,
