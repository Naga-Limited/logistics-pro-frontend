...
const TripSheetClossure = () => {
  ...
  const updated_tds_show_array = [
    {
      code:"T2",
      name:" Old Code : T2/194 C Contract 2%, New Code : C2/Contract 393(1)6(i) 2%",
      newCode:"C2"
    },
    {
      code:"T7",
      name:" Old : T7/194 C Contract 1%, New : C1/Contract 393(1)6(i) 1%",
      newCode:"C1"
    },    
    {
      code:"T9",
      name:" Old : T9/194 Q TDS on Purchase of Goods 0.1%/Exp, New : Q1/Pur.of Goods 393(1)8(ii) 0.1%",
      newCode:"Q1"
    }
  ]
  ...
  const tdsTaxCodeName = (code) => {
    ...
    tdsTaxTermsData.map((val, key) => {
      if (val.definition_list_code == code) {
        let temp = 0
        updated_tds_show_array.map((dd,ll)=>{
          if(dd.code == code){
            temp = 1
            tds_tax_code_name = dd.name
          }
        })
        if(temp == 0)
  ...
  const tdsConversion = (code) => {
    console.log(code,'tdsConversion-code') 
    let temp = 0
    let conversion_code = code
    updated_tds_show_array.map((dd,ll)=>{
      console.log(dd,'tdsConversion-updated_tds_show_array-dd') 
      if(dd.code == code){
        temp = 1
        conversion_code = dd.newCode
      }
    })
    console.log(conversion_code,'tdsConversion-conversion_code')
  ...
  const TripsheetClosureSubmit = (process) => {
    ...
    if (tripInfo.vehicle_type_id.id == '3') {
      ...
      if(tripInfo.advance_info && tripInfo.advance_info.vendor_tds){
        ...
        formData.append('vendor_tds', tripInfo.advance_info.vendor_tds ? tdsConversion(tripInfo.advance_info.vendor_tds) : '')
      ...
      if(tripInfo.vehicle_type_id && tripInfo.vehicle_type_id.id == 3 && !tripInfo.advance_payment_info){
        ...
        formData.append('supplier_ref_no',values.supplier_ref_no ? values.supplier_ref_no : tripInfo.trip_sheet_info.trip_sheet_no)
      }
                          ...
                          return (
                            <>
                              <CRow key={`HireshipmentChildData_${index}_${val_index}`}>
                                ...
                                {/* <CCol xs={12} md={2}>
                                  <CFormLabel htmlFor="sNum">Billed Shipment Qty. in MTS</CFormLabel>
