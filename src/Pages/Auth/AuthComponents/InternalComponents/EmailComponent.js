      ...
      >
        ...
        <CCardHeader className="login-header text-dark text-center" style={{ backgroundColor: "beige" }}>
          <div className="d-flex flex-column align-items-center">
            ...
            <p className="fw-bold mt-4"><h4 style={{ color: "indigo", fontFamily: "arial", fontWeight: "bold" }}>FORGOT PASSWORD</h4></p>
          ...
          <CForm className="text-center" onSubmit={handleForgetPassword}>
            <div className="container">
              ...
              <div className="d-flex justify-content-center mt-4">
                ...
                <CButton type="submit" color="secondary" className="px-3" style={{marginLeft:"5%"}}>
                  <b>Request OTP</b>
                </CButton>
              </div>
              {/* <div className="row">
