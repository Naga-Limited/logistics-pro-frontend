      ...
      >
        ...
        <CCardHeader className="login-header text-dark text-center" style={{ backgroundColor: "beige" }}>
          <div className="d-flex flex-column align-items-center">
            ...
            <p className="fw-bold mt-4"><h4 style={{ color: "indigo", fontFamily: "arial", fontWeight: "bold" }}>ENTER NEW PASSWORD</h4></p>
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="float-right">
                  <CButton disabled={enable} type="submit" color="primary" className="px-3">
                    Change Password
                  </CButton>
                </div>
              </div>
