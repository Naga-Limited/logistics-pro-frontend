    ...
    <CAlert color="info">
      ...
      <CTable style={{ height: '60vh', width: 'auto' }}>
        ...
        <CTableBody>
          ...
          <CTableRow>
            <CTableDataCell style={{ width: '10%', textAlign: 'center' }} >10.4.0</CTableDataCell>
            <CTableDataCell style={{ width: '10%', textAlign: 'center' }} >15-07-2026</CTableDataCell>
            <CTableDataCell>
              <div style={{ display: "block" }}>
                <div>
                  <NEW /> NLMT Driver Payment Process
                </div>
                <div>
                  <NEW /> NLMT Expense Approval Process
                </div>
                <div>
                  <NEW /> NLMT Income Approval Process
                </div>
                <div>
                  <ENHANCED /> NLMT Trip Closure Report
                </div>
                <div>
                  <ENHANCED /> Vehicle Utilization Report
                </div>
              </div>
            </CTableDataCell>
          </CTableRow>
